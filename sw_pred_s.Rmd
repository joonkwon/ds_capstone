...
```{r}
if (SAMPLE_MODE) { 
  ifelse(!dir.exists('./sample_wk'), dir.create('./sample_wk'), FALSE)
  setwd('./sample_wk')
...
##20 Most Frequent 4-grams
```{r dtm_quad}
freq_quad = vector()
freq_quad = readRDS("freq_quad.RDS")
if (length(freq_quad) == 0) {
  ...
  saveRDS(freq_quad, "freq_quad.RDS")
}
