...
The course provided the data. I downloaded the data from https://d396qusza40orc.cloudfront.net/dsscapstone/dataset/Coursera-SwiftKey.zip. Besides English, there are other language data too - French, German and Russian. We will focus on english only. 
All the cleaning works done using a small sample to speed up the process. English has about 600MB data. Becuase of the size, any data processing will take long time. I sampled only 10% of data to develop proper data cleaning process.
